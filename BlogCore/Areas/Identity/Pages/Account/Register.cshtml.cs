        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
...

                {
                    ...
                    //wue validate if the rols exists 
                    ...
                    //Get the value of input role

                    string rol = Request.Form["radUsuerRol"].ToString();

                    //We validate if the value of the rol is Admin if it is we add it
